...
Traditionally, due to memory constraints, switching between routing protocol implementations has required reprogramming (``reflashing'') each individual mote, which is a lengthy and manual process that quickly becomes tedious at even modest numbers of motes.
...
This becomes possible with some careful overlapping of large data structures (such as routing-protocol specific neighbor tables) using \texttt{\_\_attribute\_\_(section("name"))}.
