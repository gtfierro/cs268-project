...
The original vision of this project was to develop a new routing protocol --- 2hop --- for this common scenario and to augment a discussion of the design and implementation of this new protocol with a comparative study of RPL.
...
We provide three results in this paper.
...
Lastly, we present the design of an alternative routing protocol --- 2hop --- intended for small-diameter WSNs.
2hop takes advantage of the wireless broadcast medium to share information between nodes to better detect when control traffic is redundant in order to quiesce appropriately.
